...
A=0					## If 1, A is asymmetric (A x^2 + B describes the curve of sides; Jason Yao May31, 2023)
...
WorkingDir=`pwd`; echo $WorkingDir
XmacrosDir=$WorkingDir/../Xmacros 
XFProj=$WorkingDir/Run_Outputs/${RunName}/${RunName}.xf; echo $XFProj
#AraSimExec="/fs/ess/PAS1960/BiconeEvolutionOSC/AraSim"  ##Location of AraSim.exe
#"${WorkingDir}/../../../../AraSim" #$BEOSC/AraSim ## Location of AraSim directory
AraSimExec=${WorkingDir}/../../../../Original_GENETIS_AraSim/AraSim 
