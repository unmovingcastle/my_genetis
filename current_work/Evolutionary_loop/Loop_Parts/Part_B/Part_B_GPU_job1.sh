...
# The number of the next simulation directory is held in a hidden file in the Simulations 
# directory. The file is named .nextSimulationNumber
...
83335 85002 86668 88335 90002 91668 93335 95002 96668 98335 100000 101670 103340 105000 106670"

### below is the old frequency list--it had some small differences from the correct one above
#freqlist=
# "8333 10000 11667 13333 15000 16767 18334 20000 21667 23334 25000 26667 28334 30000 31667 
# 33333 35000 36767 38334 40001 41667 43333 45001 46767 48334 50001 51668 53334 55001 56768 
# 58334 60001 61668 63334 65001 66768 68334 70001 71667 73334 75001 76768 78334 80001 81668 
# 83335 85002 86668 88335 90002 91668 93335 95002 96668 98335 100000 101670 103340 105000 
# 106670"


# we have to wait to change the frequencies since we're going to be changing them as we append 
# them to simulation_PEC.xmacro (which is removed below before being remade)
...
# let's change our frequencies by the scale factor (and then back down by 100)
...
do
	...
	then
		...
		# (there's a space at the start; that will separate the = from the list by a space)
	fi
	...
	# the frequencies we're appending are divided by 100, 
	# since the original list was scaled up by 100. IT'S IMPORTANT TO DO IT THIS WAY.
...
then
    ...
    echo "App.saveCurrentProjectAs(\"$WorkingDir/Run_Outputs/$RunName/$RunName\");"\
		 >> simulation_PEC.xmacro 
    echo "}" >> simulation_PEC.xmacro 
fi

# we cat things into the simulation_PEC.xmacro file,
# so we can just echo the list to it before catting other files
...
# That's ok, since we're doing this after the simulation_PEC.xmacro file has been written;
# It gets deleted and rewritten from the macroskeletons, 
# so it's ok for us to make changes this way here 
# (as opposed to the way we do it for arasim in parts D1 and D2)
